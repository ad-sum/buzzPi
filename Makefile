...
test: test.c lcd_driver.o button_driver.o buzzer_driver.o
	avr-gcc $(CCOPTS) -mmcu=$(MCU) -DF_CPU=$(F_CPU) -o test -g test.c lcd_driver.o button_driver.o buzzer_driver.o
...
clean:
	rm test test.hex lcd_driver.o button_driver.o buzzer_driver.o